...
class TestOptions():
    def initialize(self):
        ...
        parser.add_argument("--data-dir-target", type=str, default='/home/inspectrone/Jay/DATA/young_train/images', help="Path to the directory containing the target dataset.")
        ...
        parser.add_argument("--restore-opt1", type=str, default='/home/inspectrone/Jay/Unsupervised_DA_Gradient_Reversal/checkpoints/DA_class4_50570', help="restore model parameters from beta1")
        ...
        parser.add_argument('--gt_dir', type=str, default='/home/inspectrone/Jay/DATA/young_train/labeled_data', help='directory for val gt images')
        parser.add_argument('--devkit_dir', type=str, default='/home/inspectrone/Jay/target_train.txt', help='list directory') 
