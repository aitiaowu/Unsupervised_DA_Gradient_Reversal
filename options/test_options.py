...
class TestOptions():
    def initialize(self):
        ...
        parser.add_argument("--save", type=str, default='/content/drive/MyDrive/Study/Domain_Adaptation_Vessel/Baseline_GR/results', help="Path to save result.")
        parser.add_argument('--gt_dir', type=str, default='/content/DATA/older_Data/labeled_data', help='directory for CityScapes val gt images')
        parser.add_argument('--devkit_dir', type=str, default='/content/sourcelist.txt', help='list directory of cityscapes')         
